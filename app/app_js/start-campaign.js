...
function pegarDataAtual() {
    data = new Date();
    document.getElementById('dataIn').value = data.getDay() + '/' + data.getMonth() + '/' + data.getFullYear();
}
function initialize() {
...
/*function initialize() {
 var mapOptions = {
 center: new google.maps.LatLng(-29.793899, -55.805377),
 zoom: 9,
 mapTypeId: 'roadmap'
 };
...
function completar() {
    document.getElementById("cidade").value = "Alegrete - RS";
    document.getElementById("bairro").value = "Ibirapuitã";
    document.getElementById("rua").value = "Avenida Tiaraju";
    document.getElementById("cep").value = "97546-550";
    document.getElementById("numero").value = "810";
}

function manterPosicao() {
    document.getElementById("icone-mapa").style.top = 2420 + "px";
}
